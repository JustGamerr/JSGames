...
function preload()
{
  ...
  p1Img = createImg("http://cosmicadventure.xyz/game/resources/p1full.gif");
  ...
  p1MovingImg = createImg("http://cosmicadventure.xyz/game/resources/p1moving.gif");

  p2Img = createImg("http://cosmicadventure.xyz/game/resources/p2full.gif");
  ...
  p2MovingImg = createImg("http://cosmicadventure.xyz/game/resources/p2moving.gif");
