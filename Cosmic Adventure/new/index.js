...
function setup()
{
    ...
    player2 = new Ship(0, 0, 20, 40, [UP_ARROW, DOWN_ARROW, LEFT_ARROW, RIGHT_ARROW, 16, 222, 13, 191], p1Img, 1, 2, 0, 100, 2);
    ...
    let aboutButton = new Button(350, 400, 200, 50, "About the Game", function () { menu.page = 3; }, color(130, 0, 180), color(180, 0, 255));
    ...
    let versionText = new Text(450, 485, 12, color(255, 255, 255), "Version: 1.4.8")
